...
public class StaggeredGridView extends ExtendableListView {
    ...
    public StaggeredGridView(final Context context, final AttributeSet attrs, final int defStyle) {
        ...
        if (attrs != null) {
            ...
            TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.StaggeredGridView0825, defStyle, 0);

            mColumnCount = typedArray.getInteger(
                    R.styleable.StaggeredGridView0825_column_count, 0);
            ...
            if (mColumnCount > 0) {
                ...
                mColumnCountPortrait = typedArray.getInteger(
                        R.styleable.StaggeredGridView0825_column_count_portrait,
                        DEFAULT_COLUMNS_PORTRAIT);
                mColumnCountLandscape = typedArray.getInteger(
                        R.styleable.StaggeredGridView0825_column_count_landscape,
                        DEFAULT_COLUMNS_LANDSCAPE);
            }

            mItemMargin = typedArray.getDimensionPixelSize(
                    R.styleable.StaggeredGridView0825_item_margin, 0);
            mGridPaddingLeft = typedArray.getDimensionPixelSize(
                    R.styleable.StaggeredGridView0825_grid_paddingLeft, 0);
            mGridPaddingRight = typedArray.getDimensionPixelSize(
                    R.styleable.StaggeredGridView0825_grid_paddingRight, 0);
            mGridPaddingTop = typedArray.getDimensionPixelSize(
                    R.styleable.StaggeredGridView0825_grid_paddingTop, 0);
            mGridPaddingBottom = typedArray.getDimensionPixelSize(
                    R.styleable.StaggeredGridView0825_grid_paddingBottom, 0);
