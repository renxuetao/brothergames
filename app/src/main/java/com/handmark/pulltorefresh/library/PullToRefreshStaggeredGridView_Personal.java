...
import com.widget.grid.StaggeredGridView;

public class PullToRefreshStaggeredGridView_Personal extends PullToRefreshBase<StaggeredGridView> {
    ...
    public PullToRefreshStaggeredGridView_Personal(Context context) {
        super(context);
    ...
    public PullToRefreshStaggeredGridView_Personal(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public PullToRefreshStaggeredGridView_Personal(Context context, Mode mode) {
        super(context, mode);
    ...
    public PullToRefreshStaggeredGridView_Personal(Context context, Mode mode, AnimationStyle style) {
...
// Does all of the hard work...
            OverscrollHelper.overScrollBy(PullToRefreshStaggeredGridView_Personal.this, deltaX, scrollX, deltaY, getScrollRange(), isTouchEvent);
...
//    	return new RedHeartLoadingLayout(context, Mode.PULL_FROM_START, getPullToRefreshScrollDirection(), a);
//    }
}
