 ...
 */
package com.handmark.pulltorefresh.library.jazzylistview;
...
import com.handmark.pulltorefresh.library.jazzylistview.effects.CardsEffect;
import com.handmark.pulltorefresh.library.jazzylistview.effects.CurlEffect;
import com.handmark.pulltorefresh.library.jazzylistview.effects.FadeEffect;
import com.handmark.pulltorefresh.library.jazzylistview.effects.FanEffect;
import com.handmark.pulltorefresh.library.jazzylistview.effects.FlipEffect;
import com.handmark.pulltorefresh.library.jazzylistview.effects.FlyEffect;
import com.handmark.pulltorefresh.library.jazzylistview.effects.GrowEffect;
import com.handmark.pulltorefresh.library.jazzylistview.effects.HelixEffect;
import com.handmark.pulltorefresh.library.jazzylistview.effects.ReverseFlyEffect;
import com.handmark.pulltorefresh.library.jazzylistview.effects.SlideInEffect;
import com.handmark.pulltorefresh.library.jazzylistview.effects.StandardEffect;
import com.handmark.pulltorefresh.library.jazzylistview.effects.TiltEffect;
import com.handmark.pulltorefresh.library.jazzylistview.effects.TwirlEffect;
import com.handmark.pulltorefresh.library.jazzylistview.effects.WaveEffect;
import com.handmark.pulltorefresh.library.jazzylistview.effects.ZipperEffect;
...
public class JazzyHelper implements AbsListView.OnScrollListener {
    ...
    private void doJazzinessImpl(View item, int position, int scrollDirection) {
    	//modify by song 2015.04.28
    	if(item == null){
    		return;
    	}
        ViewPropertyAnimator animator = ViewPropertyAnimator.animate(item)
